...
import {DatePickerDirective} from './directives-demo/datepicker.directive';
...
@NgModule({
  ...
  declarations: [PanelDemoComponent,
    ...
    BorderDirective, LowerCaseDirective, DraggableDirective, SliderDirective, DatePickerDirective,
